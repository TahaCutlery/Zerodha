      ...
      <div className="row">
        ...
        <div className="col-5 d-flex flex-column gap-4 mt-5 mx-5">
          ...
          <div>
            ...
            <div>
              <Link to={"/support"} className="text-decoration-none">Varsity <i className="fa-solid fa-arrow-right"></i></Link>
            </div>
          </div>
          <div>
            <p>Trading Q&A, the most active trading and investment community in India for all your market related queries.</p>
            <div>
              <Link to={"/support"} className="text-decoration-none">Trading Q&A <i className="fa-solid fa-arrow-right"></i></Link>
            </div>
          </div>
        </div>
      </div>
