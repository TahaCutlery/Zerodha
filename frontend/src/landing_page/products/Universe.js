      ...
      <div className="row mt-4">
        <div className="col-4 px-5">
          <div className="pt-5 px-5 mb-5">
            <img src="media/images/zerodhaFundhouse.png" className="w-75" alt='#' />
            <p className="text-muted mt-3" style={{ fontSize: "0.7rem" }}>Our asset management venture
              that is creating simple and transparent index
              funds to help you save for your goals.</p>
          </div>
          <div className="pt-5 px-5 mb-5">
            <img src="media/images/streakLogo.png" className="w-75" alt='#' />
        ...
        <div className="col-4 px-5">
          <div className="pt-5 px-5 mb-5">
            <img src="media/images/sensibullLogo.svg" className="w-75" alt='#' />
...
data points like open interest, FII/DII, and more.
          ...
          <div className="pt-5 px-5 mb-5">
            <img src="media/images/smallcaseLogo.png" className="w-75" alt='#' />
...
baskets of stocks on ETFs.</p>
        ...
        <div className="col-4 px-5">
          <div className="pt-5 px-5 mb-5">
            <img src="media/images/goldenpiLogo.png" className="w-75" alt='#' />
...
sectors, supply chains, and more.
          ...
          <div className="pt-5 px-5 mb-5">
            <img src="media/images/dittoLogo.png" className="w-75" alt='#' />
